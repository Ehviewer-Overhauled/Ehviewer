...
public class LocalFavoritesDao extends AbstractDao<LocalFavoriteInfo, Long> {
    ...
    /**
     * Properties of entity LocalFavoriteInfo.<br/>
    ...
    public LocalFavoritesDao(DaoConfig config) {
        super(config);
    }
    
    public LocalFavoritesDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"LOCAL_FAVORITES\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, LocalFavoriteInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, LocalFavoriteInfo entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getGid());
    ...
    @Override
    public LocalFavoriteInfo readEntity(Cursor cursor, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(LocalFavoriteInfo entity, long rowId) {
        entity.setGid(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(LocalFavoriteInfo entity) {
        if(entity != null) {
